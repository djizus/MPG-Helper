...
namespace MPGApp
{
    public class LeagueAnalyser
    {
        ...
        public void GetLeaguePlayerData()
        {
            ...
            var vUrl = String.Concat("https://api.monpetitgazon.com/league/", LeagueCode, "/transfer/buy");
            ...
            UserAvailablePlayers = new List<AuPlayers>(auPlayers.OrderByDescending(x => x.OurRating));
